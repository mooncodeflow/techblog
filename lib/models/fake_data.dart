...
import 'package:techblog/models/podcast.dart';

Map bannerFakeData = {
  "bannerImageAsset" : Assets.images.bannerProgramming.path,
  "writer" : 'ملیکا عزیزی',
  'date' : 'یک روز پیش',
  'views' : '253',
  'title' : 'دوازده قدم برنامه نویسی یک دوره کامل'
};

List<Hashtags> generalHashtags = [
  Hashtags(title: 'جاوا'),
  Hashtags(title: 'اندروید'),
  Hashtags(title: 'فلاتر'),
  Hashtags(title: 'ری اکت'),
  Hashtags(title: 'سوییفت'),
...
List<Podcast> podcastList = [
  Podcast(id: '1', title: 'رمزون', poster: 'https://digiato.com/wp-content/uploads/2022/04/cghjm.jpg', publisher: '', view: '', createdAt: ''),
  Podcast(id: '2', title: 'رادیو کدیاد', poster: 'https://digiato.com/wp-content/uploads/2022/04/13WELLREAD-CACIOPPO-superJumbo.jpg', publisher: '', view: '', createdAt: ''),
  Podcast(id: '3', title: 'بی پلاس', poster: 'https://digiato.com/wp-content/uploads/2022/04/1200-178443098-space-exploration-risks_smaller.jpg', publisher: '', view: '', createdAt: ''),
  Podcast(id: '4', title: 'فراکد تک', poster: 'https://digiato.com/wp-content/uploads/2022/04/photo_2022-04-29_09-06-13.jpg', publisher: '', view: '', createdAt: ''),
];