...
class ProjectGradients {
  static const List<Color> bottomNavigationGradient = [
    Color.fromARGB(255, 25, 0, 94),
    Color.fromARGB(255, 68, 4, 87)
  ];
  static const List<Color> bottomNavUnderlay = [
    Color.fromARGB(0, 255, 255, 255),
    Color.fromARGB(150, 255, 255, 255),
    Color.fromARGB(175, 255, 255, 255),
    Color.fromARGB(255, 255, 255, 255),
  ];
  static const List<Color> homeBannerOverlay = [
    Color.fromARGB(0, 0, 0, 0),
    Color.fromARGB(195, 72, 20, 88),
    Color.fromARGB(255, 28, 20, 81),
  ];
  static const List<Color> homeHashtagList = [
    Color.fromARGB(255, 84, 84, 84),
    Color.fromARGB(255, 0, 0, 0),
  ];
  static const List<Color> textOverlayGradient = [
    Color.fromARGB(0, 0, 0, 0),
    Color.fromARGB(0, 0, 0, 0),
